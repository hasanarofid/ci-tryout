...
<html
  ...
  <head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>/theme/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
      ...
      <div class="authentication-inner row">
        ...
        <div class="d-none d-lg-flex col-lg-7 p-0">
          <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
            <img
              src="<?php echo base_url(); ?>/theme/assets/img/illustrations/auth-login-illustration-light.png"
            ...
            <img
              src="<?php echo base_url(); ?>/theme/assets/img/illustrations/bg-shape-image-light.png"
              alt="auth-login-cover"
              class="platform-bg"
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <!-- /Logo -->
            <h3 class="mb-1 fw-bold">Welcome to Tryout BMC! 👋</h3>
            <p class="mb-4">Please sign-in to your account and start the adventure</p>
            <form action="" class="mb-3" method="post" name="ul" id="u_login" onsubmit="return loginUser();">
              <div class="mb-3">
